                  ...
                  <div class="block">
                    ...
                    <?php echo CHtml::beginForm("/site/login") ?>
                      <div class="form-group">
                        ...
                        <?php echo CHtml::activeTextField($user,"username",array("class"=> "form-control", "placeholder" => "Enter Username")) ?>
                        <?php echo CHtml::error($user,"username",array("class" => "bg-danger"));?>
                      </div>
                      
                      <div class="form-group">
                        <?php echo CHtml::activeLabelEx($user,"Password") ?>
                        <?php echo CHtml::activePasswordField($user,"password",array("class"=> "form-control", "placeholder" => "Enter Password")) ?>
                    ...
                    <ul class="list-group">
                      <?php foreach($categories as $category):?>
                          <li class="list-group-item">
                            <?php echo CHtml::link(
                              $category['name'],
                            "category/view/{$category['category_id']}");
                            ?>
                          </li>
                      <?php endforeach; ?>
                    </ul>
